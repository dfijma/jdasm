...
public class InnerClasses extends Attribute {
    ...
    // TODO
    public InnerClasses(ConstantPool pool) {
        super(pool);
    }

    public static InnerClasses read(ConstantPool pool, int attributeLength, InputStream is) throws ClassFileException {
        try {
