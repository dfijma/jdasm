...
public class NestMembers extends Attribute {
    ...
    public NestMembers(ConstantPool pool) {
        super(pool);
    }

    public static NestMembers read(ConstantPool pool, int attributeLength, InputStream is) throws ClassFileException {
        try {
