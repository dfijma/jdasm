...
public class LocalVariableTypeTable extends Attribute {
    ...
    // TODO
    public LocalVariableTypeTable(ConstantPool pool) {
        super(pool);
    }

    public static LocalVariableTypeTable read(ConstantPool pool, int attributeLength, InputStream is) throws ClassFileException {
        try {
        ...
        return new LocalVariableTypeTable(pool);
    }

    @Override
    public String toString() {
        return "aLocalVariableTypeTable";
    }
}
